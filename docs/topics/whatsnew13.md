...
The key differences to the old model are:
  ...
  * There is now a large number of [preset platform configurations](mpp-dsl-reference.md#targets) for different supported platforms.
  * The [dependencies configuration](kmm-add-dependencies.md) has been changed; dependencies are
